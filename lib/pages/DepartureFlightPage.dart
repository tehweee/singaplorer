...
import 'DepartureFlightDetailPage.dart'; // Make sure this file exists
import 'DepartureFlightFilter.dart'; // Make sure this file exists
import '../models/FlightModel.dart'; // Make sure this file exists and has the Flight class
...
class _DepartureFlightPageState extends State<DepartureFlightPage> {
  ...
  String _from = 'LHR.AIRPORT'; // London Heathrow Airport
  String _to = 'SIN.AIRPORT'; // Changi Airport
