...
class _DepartureFlightDetailPageState extends State<DepartureFlightDetailPage> {
  ...
  // Helper function to format only the time (e.g., "04:10 PM") - Not used in detail page, but kept for consistency
  String _formatTime(String dateTimeString) {
    try {
      ...
      return dateTimeString
          .split('T')
          .last; // Return just the time part if parsing fails
    }
  }
                                  ...
                                  onPressed: () {
                                    ...
                                    showDialog(
                                      ...
                                      builder: (_) => AlertDialog(
                                        ...
                                        content: const Text(
                                          'Your flight has been successfully booked. Proceed to find a hotel?',
