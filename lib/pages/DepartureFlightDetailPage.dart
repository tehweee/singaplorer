...
class DepartureFlightDetailPage extends StatefulWidget {
  ...
  @override
  State<DepartureFlightDetailPage> createState() => _DepartureFlightDetailPageState();
}
                ...
                return Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        _infoRow('From:', '${flight.departureAirport}, ${flight.departureCountry}'),
                        _infoRow('To:', '${flight.arrivalAirport}, ${flight.arrivalCountry}'),
                        ...
                        _infoRow('Price:', '\$${flight.price}', isBold: true),
                                                _infoRow('Cabin Class:', '\$${flight.cabinClass}', isBold: true),

                        const SizedBox(height: 20),
                        Center(
                          child: ElevatedButton(
                            onPressed: () {
                              _checkout(flight.departureCountry,flight.departureAirport,flight.departureTime,flight.arrivalTime,flight.price,flight.cabinClass);
                              showDialog(
                                context: context,
                                builder: (_) => AlertDialog(
                                  title: Text('Booking Confirmed'),
                                  content: Text('You have booked the flight with token: ${flight.token}'),
                                  actions: [
                                    TextButton(
...
void _checkout(country,airport,departTime,arrivalTime,price,cabin) async {
    final uri = Uri.parse('http://10.0.2.2:3000/api/departure/flights/checkout');
