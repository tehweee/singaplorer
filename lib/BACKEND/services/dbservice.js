...
let db = {
  ...
  async getManualPlanItinerary(userID) {
    ...
    async getArriveById(id){
        try{
            let result = await arrivesg.findById(id).select();
            return result;
        }
        catch(e){
            console.log(e.message);
        ...
        try{
            let result = await departsg.findById(id).select();
            return result;
        }
        catch(e){
            console.log(e.message);
    ...
    async getHotelById(id){
        try{
            let result = await hotel.findById(id).select();
            return result;
        }
        catch(e){
            console.log(e.message);
